...
@router.post("/regenerate-backup-codes", response_model=TOTPRegenerateBackupCodesResponse)
async def regenerate_backup_codes(
    ...
    """
    Regenerate backup codes for an active 2FA setup.

    Returns 10 new backup codes in plaintext (shown only once).
    ...
    return TOTPRegenerateBackupCodesResponse(
        backup_codes=plaintext_codes,
        message="10 new backup codes generated successfully",
    )
